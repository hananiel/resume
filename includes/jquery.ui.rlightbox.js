...
/*
     FILE ARCHIVED ON 8:39:33 Aug 3, 2015 AND RETRIEVED FROM THE
...
$.extend($.ui.rlightbox, {
	global: {
		addToSet: function( setElement ) {
			...
			//		setName: [
			//			{
			//				url: "/web/20150803083933/http://www.youtube.com?v=u408408598,
			//				type: "youtube"
			//			},
			//			{…}
			//		],
		...
		loadContentImage: function( url ) {
			...
			$newImage
				...
				.each(
					function() {
						// the code comes from /web/20150803083933/https://github.com/desandro/imagesloaded
						// cached images don't fire load sometimes, so we reset src.
						if ( this.complete || this.complete === undefined ){
						  var src = this.src;
						  // webkit hack from /web/20150803083933/http://groups.google.com/group/jquery-dev/browse_thread/thread/eee6ab7b2da50e1f
		...
		data: {
			...
			providers: {
				vimeo: "/web/20150803083933/http://www.vimeo.com/api/oembed.json?callback=?",
				youtube: "/web/20150803083933/http://gdata.youtube.com/feeds/api/videos/"
			},
			...
			htmlErrorScreen: "" +
				"<div id='ui-lightbox-error'>" +
					...
					"</div>" +
				"</div>",
			htmlYoutube: "<iframe class='youtube-player' type='text/html' width='{width}' height='{height}' src='/web/20150803083933/http://www.youtube.com/embed/{url}' frameborder='0'></iframe>",
			htmlLightbox: "" +
